...
const HizbEighthList :AyahId[] = [  //generated by text comparison and manual waork
...
const calculateThumuns = (start: AyahId, end: AyahId) => {
...
const targetedFullThumunsArray = HizbEighthList.slice(startFullThumunIndex,endFullThumunIndex)
const fullThumuns = targetedFullThumunsArray.length
...
const getAyahText = (ayah: AyahNo, surah: Surah) => normalizeArabic(quranJson[surah].verses[ayah - 1].text)
