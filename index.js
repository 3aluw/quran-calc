...
var ThumunPortionCalculator = function (start, end) {
    var realizedAyahs = [];
    var unrealizedAyahs = [];
    var thumunBoundaries = getThumunBoundaries(start);
    var AyahToCheck = thumunBoundaries.start;
    var endSearch = thumunBoundaries.end;
    while (AyahToCheck <= endSearch) {
        var ayahSurah = (0, quran_meta_1.findSurahAyahByAyahId)(AyahToCheck);
        var ayahText = getAyahText(ayahSurah[1], ayahSurah[0]);
